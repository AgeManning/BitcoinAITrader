...
Hash = SHA256.new(<passwordtoDecryptcfgFiles>).digest()

## Global Variables ##
####################################
## Decide logic if market crashes
## Trader Symantics ##
TraderFlag                  = True              # Run with AI and Trading Algorithms
...
AILearningLifetime          = 24                # In Hours
PercentageChangeToPredict   = 2                 # This is the percentage the AI is predicting. Can define a list.
PeriodsToPredict            = [30,50,60,90,180]          # Average Over Predictive successes
AcceptanceThreshold         = 0.1               # Threshold before we classify a positive or negative. Higher value = safer betting.
AIType                      = "RandomForest"    # Choice of "SVM", "RandomForest"
## BUY/SELL Trade Specific ##
PercentageOfTotalMoney      = 10                # Percentage of Money in the account to trade with.
RequiredPredictionsToBuy    = 1
RequiredPredictionsToSell   = 1                 # Can specify how 'scared' we are. If this is smaller it is safer, but we may not reach high peaks. More suceptible to fluctuations.
